      ...
      <header className="flex flex-col gap-3 border-b border-slate-200 pb-4 md:flex-row md:items-end md:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Indicadores orientados al impacto económico del turismo: actividad,
            empleo, gasto, rentas y retorno para el destino.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end">
          ...
          <div className="flex flex-col text-sm">
            ...
            <input
              ...
              placeholder="Indicador, fuente, fórmula, comentarios…"
          ...
          {cards.length === 0 ? (
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {cards.map((row) => {
                ...
                const source = row.fuente ?? row.organismo ?? null;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <div className="text-xs font-medium text-[#7F1D1D] group-hover:text-[#9F1239]">
                        Ver detalle →
                      </div>
                      <BadgeEuro className="h-4 w-4 text-slate-400" />
                    </div>
                  </button>
                );
              })}
...
const StatCard: FC<{ label: string; value: string; accent?: boolean }> = ({
  label,
  value,
  accent,
}) => (
